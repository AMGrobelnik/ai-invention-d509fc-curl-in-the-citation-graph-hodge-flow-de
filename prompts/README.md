...
- **1. create_idea** — `hypo_loop`
  - round_1
    - `prompts/1_create_idea/round_1/1_gen_hypo.md` — 5 prompt(s)
    - `prompts/1_create_idea/round_1/2_review_hypo.md` — 3 prompt(s)
- **2. test_idea** — `invention_loop`
  - round_1
    - `prompts/2_test_idea/round_1/1_gen_strat.md` — 3 prompt(s)
    - `2_gen_plan/` — 3 task(s)
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_dataset_1.md` — 4 prompt(s)
      - `prompts/2_test_idea/round_1/2_gen_plan/gen_plan_experiment_1.md` — 4 prompt(s)
    ...
    - `3_gen_art/` — 3 task(s)
      ...
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_experiment_1.md` — 14 prompt(s)
      - `prompts/2_test_idea/round_1/3_gen_art/gen_art_research_1.md` — 5 prompt(s)
    - `prompts/2_test_idea/round_1/4_gen_paper_text.md` — 5 prompt(s)
    - `prompts/2_test_idea/round_1/5_review_paper.md` — 4 prompt(s)
  ...
  - round_2
    ...
    - `2_gen_plan/` — 2 task(s)
      ...
      - `prompts/2_test_idea/round_2/2_gen_plan/gen_plan_research_1.md` — 3 prompt(s)
    - `3_gen_art/` — 2 task(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_experiment_1.md` — 10 prompt(s)
      - `prompts/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 5 prompt(s)
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    ...
    - `prompts/3_report_results/1_gen_viz/gen_viz_3.md` — 3 prompt(s)
    - `prompts/3_report_results/1_gen_viz/gen_viz_4.md` — 7 prompt(s)
  - `2_gen_demo_art/` — 3 task(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_dataset_1.md` — 7 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_1.md` — 5 prompt(s)
    - `prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 9 prompt(s)
