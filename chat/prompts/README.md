...
- **2. test_idea** — `invention_loop`
  - round_1
    ...
    - `3_gen_art/` — 3 task(s)
      - `chat/prompts/2_test_idea/round_1/3_gen_art/gen_art_dataset_1.md` — 16 prompts
    ...
    - `chat/prompts/2_test_idea/round_1/5_review_paper.md` — 4 prompts
  ...
  - round_2
    ...
    - `3_gen_art/` — 2 task(s)
      ...
      - `chat/prompts/2_test_idea/round_2/3_gen_art/gen_art_research_1.md` — 5 prompts
...
- **3. report_results** — `gen_paper_repo`
  - `1_gen_viz/` — 4 task(s)
    ...
    - `chat/prompts/3_report_results/1_gen_viz/gen_viz_4.md` — 7 prompts
  - `2_gen_demo_art/` — 3 task(s)
    ...
    - `chat/prompts/3_report_results/2_gen_demo_art/gen_demo_art_experiment_2.md` — 9 prompts
